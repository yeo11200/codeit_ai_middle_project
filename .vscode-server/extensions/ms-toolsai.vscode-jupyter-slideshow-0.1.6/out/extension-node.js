...
exports.updateSlideType = exports.getSlideType = exports.register = exports.reviveCell = exports.getActiveCell = exports.CellSlideShowStatusBarProvider = void 0;
...
function register(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('jupyter-slideshow.switchSlideType', (cell) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (selected) {
            ...
            yield updateSlideType(cell, selectedType);
        }
    })));
...
function getSlideType(cell) {
    var _a, _b, _c, _d;
    const slideshow = (_d = (useCustomMetadata() ? (_b = (_a = cell.metadata.custom) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.slideshow : (_c = cell.metadata.metadata) === null || _c === void 0 ? void 0 : _c.slideshow)) !== null && _d !== void 0 ? _d : undefined;
    return slideshow === null || slideshow === void 0 ? void 0 : slideshow.slide_type;
}
exports.getSlideType = getSlideType;
function updateSlideType(cell, slideType) {
...
exports.updateSlideType = updateSlideType;

...
exports.register = exports.reviveCell = exports.getActiveCell = exports.CellTagStatusBarProvider = exports.addCellTag = void 0;
const vscode = __webpack_require__(2);
const json = __webpack_require__(3);
const helper_1 = __webpack_require__(4);
function addCellTag(cell, tags) {
    return __awaiter(this, void 0, void 0, function* () {
        const oldTags = (0, helper_1.getCellTags)(cell);
        const newTags = [];
        ...
        yield (0, helper_1.updateCellTags)(cell, oldTags);
    });
}
exports.addCellTag = addCellTag;
class CellTagStatusBarProvider {
    provideCellStatusBarItems(cell, token) {
        const items = [];
        (0, helper_1.getCellTags)(cell).forEach((tag) => {
            items.push({
                text: '$(close) ' + tag,
                tooltip: tag,
                command: {
...
exports.CellTagStatusBarProvider = CellTagStatusBarProvider;
...
function register(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('jupyter-cell-tags.removeTag', (cell, tag) => __awaiter(this, void 0, void 0, function* () {
        let activeCell;
        ...
        const tags = (0, helper_1.getCellTags)(activeCell);
        // remove tag from tags
        const index = tags.indexOf(tag);
        if (index > -1) {
            tags.splice(index, 1);
            yield (0, helper_1.updateCellTags)(activeCell, tags);
        }
    })));
    context.subscriptions.push(vscode.commands.registerCommand('jupyter-cell-tags.addTag', (cell) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (tag) {
            yield addCellTag(cell, [tag]);
        }
    })));
    context.subscriptions.push(vscode.commands.registerCommand('jupyter-cell-tags.paramaterize', (cell) => __awaiter(this, void 0, void 0, function* () {
        cell = reviveCell(cell);
        if (!cell) {
            return;
        }
        yield addCellTag(cell, ['parameters']);
    })));
    context.subscriptions.push(vscode.commands.registerCommand('jupyter-cell-tags.editTagsInJSON', (cell) => __awaiter(this, void 0, void 0, function* () {
        cell = reviveCell(cell);
        if (!cell) {
            return;
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updateCellTags = exports.getCellTags = void 0;
const vscode = __webpack_require__(2);
function getCellTags(cell) {
    var _a, _b, _c, _d;
    const currentTags = (_d = (useCustomMetadata() ? (_b = (_a = cell.metadata.custom) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.tags : (_c = cell.metadata.metadata) === null || _c === void 0 ? void 0 : _c.tags)) !== null && _d !== void 0 ? _d : [];
    return [...currentTags];
}
exports.getCellTags = getCellTags;
function updateCellTags(cell, tags) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.updateCellTags = updateCellTags;
function useCustomMetadata() {
    var _a;
    if ((_a = vscode.extensions.getExtension('vscode.ipynb')) === null || _a === void 0 ? void 0 : _a.exports.dropCustomMetadata) {
        return false;
    }
    return true;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.register = exports.TagTreeDataProvider = void 0;
const vscode = __webpack_require__(2);
const helper_1 = __webpack_require__(4);
class TagTreeDataProvider {
    ...
    registerEditorListeners(editor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode.commands.executeCommand('setContext', 'jupyter:showTagsExplorer', true);
            this._editorDisposables = [];
...
const cellTags_1 = __webpack_require__(1);
const cellTagsTreeDataProvider_1 = __webpack_require__(5);
function activate(context) {
    (0, cellTags_1.register)(context);
    (0, cellTagsTreeDataProvider_1.register)(context);
}
